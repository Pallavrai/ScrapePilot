...
Read `IMPLEMENTATION_PLAN.md`, `IMPLEMENTATION_STATUS.md`, `CHANGELOG.md`, and `README.md` before changing the implementation. `DEPLOYMENT.md` documents operator setup and recovery. See `apps/web/AGENTS.md` for the installed Next.js documentation requirement.
